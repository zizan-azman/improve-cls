import layoutShift1 from "@/assets/images/hero-image-element/hero-image-media-no-dimension.png";
import layoutShift2 from "@/assets/images/hero-image-element/hero-image-poor-cls-score.png";
...
export const HERO_IMAGE_LAYOUT_SHIFT_MOCK: HeroImageConfig = {
  type: "layout-shift",
  heading:
    "Layout shift caused by img or video element inside a flex container",
  teaser: {
    imgWidth: undefined,
    imgHeight: undefined,
