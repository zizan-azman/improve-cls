...
export const HERO_CONTAINER_WIDTH_HEIGHT_MOCK: HeroContainerConfig = {
  ...
  teaser: {
    ...
    paragraphs: [
      ...
      {
        uniqueID: "4",
        text: "To revisit the original example that demonstrates a layout shift issue with media containers, check out the link below.",
      },
    ],
    links: [
      {
        ...
        text: "View layout shift example",
      },
    ],
  },
  contentEnd: {
